...
test('26.login user see Details page', async ({page}) => {
...
test('27.Guest user see Details page', async ({page}) => {    
...
test('28.Details page should content all information', async ({page}) => {
...
test('29.Details page should like button for creator', async ({page}) => {
...
test('30.Logout should work properly', async ({page}) => {
